...
class CandleStickChart extends React.Component {
  ...
  render() {
    var { data, type, width, onLoadMoreData } = this.props;
    ...
    return (
      <ChartCanvas ref="chartCanvas" width={width} height={600}
        ...
        <EventCapture mouseMove={true} zoom={true} pan={true} onLoadMoreData={onLoadMoreData} />
        <TooltipContainer>
...
export default infiniteLoadingWrapper(fitWidth(CandleStickChart));
